...
<body class="bg-light">
    ...
    <form action="{{ route('film.update', $film->id)}}" method='Post' enctype="multipart/form-data">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <a href="{{ route('film.index') }}" class="btn btn-danger">Back</a>
        </div>
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control" name="sinopsis" id="sinopsis" {{ $film->sinopsis }} rows="5">{{ $film->sinopsis }}</textarea>
                </div>
            </div>
            <div class="mb-3 row">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="rating" value="{{ $film->rating }}"  id="rating" >
                </div>
            </div>
            <div class="mb-3 row">
                <label for="durasi" class="col-sm-2 col-form-label">Durasi</label>
                <div class="col-sm-10">
                    <input type="number" class="form-control" name='durasi' value="{{ $film->durasi }}" id="durasi">
                </div>
            </div>
            <div class="mb-3 row">
                <label for="genre" class="col-sm-2 col-form-label">Genre</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name='genre' value="{{ $film->genre}}" id="genre">
                </div>
            </div>
            <div class="mb-3 row">
                <label for="tahun_rilis" class="col-sm-2 col-form-label">Tahun Rilis</label>
                <div class="col-sm-10">
                    <input type="number" class="form-control" name='tahun_rilis' value="{{ $film->tahun_rilis }}" id="tahun_rilis">
                </div>
            </div>
            <div class="mb-3 row">
                <label for="link" class="col-sm-2 col-form-label">Link</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name='link' value="{{ $film->link }}" id="link">
                </div>
            </div>
            <div class="mb-3 row">
